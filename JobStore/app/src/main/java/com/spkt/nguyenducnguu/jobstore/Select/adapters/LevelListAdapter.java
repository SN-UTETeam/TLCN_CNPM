...
public class LevelListAdapter extends BaseAdapter {
    private List<Level> listData;
    private List<String> listDataSelected;
    private LayoutInflater layoutInflater;
    private Context context;

    public LevelListAdapter(Context aContext,  List<Level> listData, List<String> listDataSelected) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if (view == null) {
            view = layoutInflater.inflate(R.layout.list_item_level_layout, null);
