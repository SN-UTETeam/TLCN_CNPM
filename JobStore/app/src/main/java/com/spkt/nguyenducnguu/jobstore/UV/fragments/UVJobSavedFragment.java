...
import com.spkt.nguyenducnguu.jobstore.UV.activities.UVFilterSearchActivity;
...
public class UVJobSavedFragment extends Fragment {
    ...
    UVSearchWorkInfoListAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_uv_jobsaved, container, false);
    ...
    private void setmRecyclerView(){
        mAdapter = new UVSearchWorkInfoListAdapter(lstData);
